                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            ...
                            <div class="banner-icon">
                                <img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-1.png') }}" alt="" />
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".1s">
                            <div class="banner-icon">
                                <img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-2.png') }}" alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".2s">
                            <div class="banner-icon">
                                <img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-3.png') }}" alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".4s">
                            <div class="banner-icon">
                                <img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-5.png') }}" alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-xl-3">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                            ...
                            <ul class="contact-infor">
                                <li><img src="{{ asset('assets/frontend/dist/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address:

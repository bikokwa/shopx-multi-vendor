                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30" data-wow-delay=".2s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-2-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-2-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30" data-wow-delay=".3s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-3-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-3-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30" data-wow-delay=".4s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-4-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-4-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30" data-wow-delay=".5s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-5-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-5-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap" data-wow-delay=".1s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-6-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-6-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap" data-wow-delay=".3s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-8-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-8-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap" data-wow-delay=".4s">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#" tabindex="-1">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-9-1.jpg') }}" alt="">
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-9-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn"
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-9-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-9-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-8-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-8-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-7-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-7-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-6-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-6-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-5-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-5-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-4-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-4-2.jpg') }}" alt="" />
                                            </a>
                                        </div>
                            ...
                            <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img class="default-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-2-1.jpg') }}"
                                                    alt="" />
                                                <img class="hover-img" src="{{ asset('assets/frontend/dist/imgs/shop/product-2-2.jpg') }}" alt="" />
                                            </a>
                                        </div>

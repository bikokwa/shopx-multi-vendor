...
->group(function () {
    ...
    Route::get('/kyc-requests/{kyc_request}/download', [KycRequestController::class, 'download'])->name('kyc.download');
    ...
    Route::put('/settings/general-settings', [SettingsController::class, 'generalSettings'])->name('settings.general');
});
